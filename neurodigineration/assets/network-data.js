...
//
// Coverage as of Round 6: 311 nodes and 474 edges across 11 disease groups
...
export const EDGES = [
  ...
  { from: 'CALCOCO2', to: 'TBK1', kind: 'kinase-substrate', strength: 0.80, pmids: [],
  ...
  { from: 'FUNDC1', to: 'ULK1', kind: 'kinase-substrate', strength: 0.80, pmids: [],
  ...
  { from: 'MFN1', to: 'PRKN', kind: 'kinase-substrate', strength: 0.70, pmids: [],
  ...
  { from: 'RAB8A', to: 'LRRK2', kind: 'kinase-substrate', strength: 0.90, pmids: [],
  ...
  { from: 'RHOT1', to: 'PINK1', kind: 'kinase-substrate', strength: 0.80, pmids: [],
  ...
  { from: 'RHOT1', to: 'PRKN', kind: 'kinase-substrate', strength: 0.80, pmids: [],
  ...
  { from: 'NR4A2', to: 'TH', kind: 'kinase-substrate', strength: 0.60, pmids: [],
  ...
  { from: 'PITX3', to: 'TH', kind: 'kinase-substrate', strength: 0.50, tentative: true, pmids: [],
  ...
  { from: 'FYN', to: 'PRNP', kind: 'receptor-ligand', strength: 0.60, tentative: true, pmids: [],
  ...
  { from: 'ADAM17', to: 'APP', kind: 'kinase-substrate', strength: 0.60, pmids: [],
  ...
  { from: 'ADAM17', to: 'TREM2', kind: 'kinase-substrate', strength: 0.60, pmids: [],
  ...
  { from: 'CDK5R1', to: 'CDK5', kind: 'receptor-ligand', strength: 0.80, pmids: [],
  ...
  { from: 'CDK5R1', to: 'MAPT', kind: 'kinase-substrate', strength: 0.50, tentative: true, pmids: [],
    note: 'Through CDK5, the p35/p25 activator targets multiple proline-directed sites on tau.' },
  { from: 'PPP2CA', to: 'MAPT', kind: 'kinase-substrate', strength: 0.80, pmids: [],
  ...
  { from: 'PPP3CA', to: 'MAPT', kind: 'kinase-substrate', strength: 0.60, pmids: [],
  ...
  { from: 'NMNAT2', to: 'SARM1', kind: 'opposes', strength: 0.70, pmids: [],
    note: 'NMNAT2 is the labile axon-survival factor whose loss licenses SARM1 activation; the NMNAT2-SARM1 axis is the core of programmed axon death.' },
  ...
  { from: 'PPARGC1A', to: 'TFAM', kind: 'kinase-substrate', strength: 0.50, tentative: true, pmids: [],
  ...
  { from: 'SUMF1', to: 'SGSH', kind: 'kinase-substrate', strength: 0.60, pmids: [],
  ...
  { from: 'SUMF1', to: 'ARSA', kind: 'kinase-substrate', strength: 0.60, pmids: [],
  ...
  { from: 'MUL1', to: 'MFN2', kind: 'kinase-substrate', strength: 0.50, tentative: true, pmids: [],
  ...
  { from: 'LONP1', to: 'TFAM', kind: 'kinase-substrate', strength: 0.50, tentative: true, pmids: [],
  ...
  { from: 'SYK', to: 'TREM2', kind: 'kinase-substrate', strength: 0.80, pmids: [],
  ...
  { from: 'STUB1', to: 'MAPT', kind: 'kinase-substrate', strength: 0.60, pmids: [],
  ...
  { from: 'ERN1', to: 'XBP1', kind: 'kinase-substrate', strength: 0.80, pmids: [],
  ...
  { from: 'ATF4', to: 'DDIT3', kind: 'kinase-substrate', strength: 0.70, pmids: [],
  ...
  { from: 'ATF4', to: 'EIF2S1', kind: 'shared-mechanism', strength: 0.70, pmids: [],
    note: 'Phosphorylation of eIF2-alpha (EIF2S1) preferentially translates ATF4, the master integrated-stress-response effector.' },
  { from: 'DDIT3', to: 'EIF2AK3', kind: 'shared-mechanism', strength: 0.60, tentative: true, pmids: [],
  ...
  { from: 'SNCAIP', to: 'PRKN', kind: 'kinase-substrate', strength: 0.50, tentative: true, pmids: [],
